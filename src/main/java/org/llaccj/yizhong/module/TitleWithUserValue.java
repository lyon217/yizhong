...
@Component
public class TitleWithUserValue {
    ...
    public TitleWithUserValue(Integer id, String titlename, Integer authorid, String authorname, String authorheadurl, String picurl, Date posttime, Date beginTime, Date endTime, Integer codeone, Integer codetwo, Integer likenum, Integer unlikenum, Integer collectnum, String ip, String content) {
        this.id = id;
    ...
    public TitleWithUserValue(Title title) {
        this.id = title.getId();
        this.titlename = title.getTitlename();
        this.authorid = title.getAuthorid();
        this.authorname = title.getAuthorname();
        this.picurl = title.getPicurl();
        this.posttime = title.getPosttime();
        this.beginTime = title.getBeginTime();
        this.endTime = title.getEndTime();
        this.codeone = title.getCodeone();
        this.codetwo = title.getCodetwo();
        this.likenum = title.getLikenum();
        this.unlikenum = title.getUnlikenum();
        this.collectnum = title.getCollectnum();
        this.ip = title.getIp();
    }


    public TitleWithUserValue(Integer id, String titlename, Integer authorid, String authorname, String authorheadurl, String picurl, Date posttime, Date beginTime, Date endTime, Integer codeone, Integer codetwo, Integer likenum, Integer unlikenum, Integer collectnum, String ip) {
        this.id = id;
        this.titlename = titlename;
        this.authorid = authorid;
        this.authorname = authorname;
